...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field mucua on 'Repository'
        m2m_table_name = db.shorten_name(u'repository_repository_mucua')
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field mucua on 'Repository'
        db.delete_table(db.shorten_name(u'repository_repository_mucua'))
