...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'media_media', (
            ...
            ('uuid', self.gf('django.db.models.fields.CharField')(default='c295694a-50f3-4c95-98fb-780a1fc71fae', max_length=36)),
    ...
    models = {
        ...
        u'media.media': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'c295694a-50f3-4c95-98fb-780a1fc71fae'", 'max_length': '36'})
        },
