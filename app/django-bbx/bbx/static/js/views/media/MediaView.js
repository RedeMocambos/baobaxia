define([
    ...
    'modules/media/model',
    'text!/api/templates/' + userLang + '/media/MediaView.html',
    'text!/api/templates/' + userLang + '/media/BackToSearch.html',
    'text!/api/templates/' + userLang + '/media/MucuaHasFile.html',
