...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Media.last_modified'
        db.add_column(u'media_media', 'last_modified',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2015, 4, 11, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Media.last_modified'
        db.delete_column(u'media_media', 'last_modified')
    ...
    models = {
        ...
        u'media.media': {
            ...
            'last_modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 4, 11, 0, 0)'}),
