...
urlpatterns = patterns('mucua.views',
                       ...
                       url(r'^mucua/groups/(?P<name>[a-zA-Z0-9\-]+)', 'mucua_get_groups'),
                       url(r'^mucua/groups/', 'mucua_get_groups'),
                       url(r'^mucua/groupadd/(?P<name>[a-zA-Z0-9\-]+)/(?P<group>[a-zA-Z0-9\-]+)', 'mucua_add_group'),
                       url(r'^mucua/groupdel/(?P<name>[a-zA-Z0-9\-]+)/(?P<group>[a-zA-Z0-9\-]+)', 'mucua_del_group'),
